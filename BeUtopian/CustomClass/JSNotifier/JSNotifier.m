...
- (id)initWithTitle:(NSString *)title position:(JSNotifierPosition)position {
    ...
    if (self = [super initWithFrame:CGRectMake(0, top, width, kHeight)]){
        ...
        _txtLabel = [[UILabel alloc]initWithFrame:CGRectMake(55, 8, self.frame.size.width - 70, 40)];
        [_txtLabel setFont:[UIFont fontWithName: @".SFUIText-Regular" size: 14]];
...
//        _txtLabel.layer.masksToBounds = NO;
        ...
        UIButton *btnclose = [[UIButton alloc] initWithFrame:CGRectMake(self.frame.size.width - 30, 0, 30, 30)];
...
- (void)setAccessoryView:(UIView *)__accessoryView{
    ...
    if (__accessoryView)
        [_txtLabel setFrame:CGRectMake(55, 8, self.frame.size.width - 70, 45)];
    else
        [_txtLabel setFrame:CGRectMake(55, 8, self.frame.size.width - 70, 45)];
}

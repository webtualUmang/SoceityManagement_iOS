        ...
        for (int i = 0; i < [aImageUrls count]; i++) {
            ...
            if([[aImageUrls objectAtIndex:i] isKindOfClass:[UIImage class]]) {
                ...
                [self.imageSource imageWithUrl:imageUrl
                 ...
                 {
//                     image = [self imageWithGradient:image startColor:[UIColor blackColor] endColor:[UIColor clearColor]];
...
- (void) setCurrentPage:(NSUInteger)currentPage animated:(BOOL)animated
{
    ...
    [_scrollView scrollRectToVisible:CGRectMake(self.frame.size.width * currentPage, 0, self.frame.size.width, self.frame.size.width) animated:animated];
                 ...
                 - (UIImage *)imageWithGradient:(UIImage *)img startColor:(UIColor *)color1 endColor:(UIColor *)color2 {
                     ...
                     CGContextDrawLinearGradient(context, gradient, CGPointMake(0,0), CGPointMake(0, img.size.height / 1.5), 0);

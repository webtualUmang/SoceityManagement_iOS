...
@IBDesignable class LBZSpinner : UIView, UITableViewDelegate, UITableViewDataSource {
    ...
    fileprivate func initCustomView() {
        ...
        NotificationCenter.default.addObserver(self, selector: "orientationChanged", name: UIDevice.orientationDidChangeNotification, object: nil)
    ...
    //MARK:- Custom Open Spinner Click -
    func manualyOpenSpinner(){
